...
public class Activity6 {
    ...
    public void activityMenuTest() {
        WebElement activitiesMenuElement = driver.findElement(By.id("grouptab_3"));

        Assert.assertTrue(activitiesMenuElement.isDisplayed());
        Assert.assertTrue(activitiesMenuElement.isEnabled());
    }
