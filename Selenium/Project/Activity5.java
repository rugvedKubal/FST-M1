...
public class Activity5 {
    ...
    public void printNavBarColor() {
        String navBarColor = driver.findElement(By.className("desktop-toolbar")).getCssValue("color");
        System.out.println("Navigation bar color is: "+navBarColor);
    }
